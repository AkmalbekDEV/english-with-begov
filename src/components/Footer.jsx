        ...
        <div className='flex items-center justify-between max-sm:flex-col max-sm:gap-10 max-sm:text-center'>
          <div className='grid'>
            <div className='max-sm:flex max-sm:justify-center max-sm:flex-col'>
              ...
              <Link to={"https://begov-home-changer.vercel.app"} className='text-xl font-medium max-sm:mr-5 w-full flex items-center justify-center py-3 px-5 rounded-xl bg-gray-100'>Xolatingizni tekshiring!</Link>
            </div>
          </div>
