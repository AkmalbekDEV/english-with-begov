...
const Teachers = () => {
    ...
    return (
        <section id='teachers' className='grid gap-10 mt-5'>
            <div className='flex max-sm:flex-col-reverse gap-16 max-sm:gap-10 items-center px-8 py-5 max-sm:px-5 max-sm:py-5'>
                <div className='grid content-between gap-10 max-sm:gap-5 max-sm:text-center'>
                    <h1 className='text-4xl font-bold'>Hi, I'm <span className='text-blue-700'>Begov</span></h1>
                ...
                <img src={Begov} className='w-[35%] mb-20 max-sm:mb-0 max-sm:w-full rounded-2xl' alt="" />
            </div>
        </section>
    )
}
